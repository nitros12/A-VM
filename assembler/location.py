...
class Reference(Compilable):
    ...
    def compile(self, context):
        ...
        raise Exception(
            f"Cannnot compile {self.t} object of type {type(self.t)} into a raw memory location or unresolved label")
...
def match_enum(enum_, *, prefix=None):
    ...
    match = pp.MatchFirst(get_tok(i.name.rstrip("_")) for i in enum_)  # type: pp.MatchFirst
